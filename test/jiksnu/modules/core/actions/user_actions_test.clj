(ns jiksnu.modules.core.actions.user-actions-test
...
(fact "#'jiksnu.modules.core.actions.user-actions/get-username-from-http-uri"
...
(fact "#'jiksnu.modules.core.actions.user-actions/get-username"
  (let [username (fseq :username)
        domain-name (fseq :domain)
...
(fact "#'jiksnu.modules.core.actions.user-actions/get-domain"
...
(fact "#'jiksnu.modules.core.actions.user-actions/create"
...
(fact "#'jiksnu.modules.core.actions.user-actions/index"
  (actions.user/index {}) => map?)

(fact "#'jiksnu.modules.core.actions.user-actions/find-or-create"
  (let [username (fseq :username)
        domain-name (fseq :domain)
...
(fact "#'jiksnu.modules.core.actions.user-actions/register"
  (let [params {:username (fseq :username)
                :email (fseq :email)
                :name (fseq :name)
                :bio (fseq :bio)
